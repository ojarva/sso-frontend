...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'CSPReport', fields ['username']
        db.create_index(u'cspreporting_cspreport', ['username'])

        # Adding index on 'CSPReport', fields ['source_file']
        db.create_index(u'cspreporting_cspreport', ['source_file'])


    def backwards(self, orm):
        # Removing index on 'CSPReport', fields ['source_file']
        db.delete_index(u'cspreporting_cspreport', ['source_file'])

        # Removing index on 'CSPReport', fields ['username']
        db.delete_index(u'cspreporting_cspreport', ['username'])
