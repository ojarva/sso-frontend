...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Browser.bid_public'
        db.add_column(u'login_frontend_browser', 'bid_public',
                      self.gf('django.db.models.fields.CharField')(default=' ', max_length=37),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Browser.bid_public'
        db.delete_column(u'login_frontend_browser', 'bid_public')
