...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'KeystrokeSequence.resolution'
        db.alter_column(u'login_frontend_keystrokesequence', 'resolution', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'KeystrokeSequence.resolution'
        db.alter_column(u'login_frontend_keystrokesequence', 'resolution', self.gf('django.db.models.fields.CharField')(default=' ', max_length=30))
