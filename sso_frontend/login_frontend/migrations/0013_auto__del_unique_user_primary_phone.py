...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'User', fields ['primary_phone']
        db.delete_unique(u'login_frontend_user', ['primary_phone'])


    def backwards(self, orm):
        # Adding unique constraint on 'User', fields ['primary_phone']
        db.create_unique(u'login_frontend_user', ['primary_phone'])
