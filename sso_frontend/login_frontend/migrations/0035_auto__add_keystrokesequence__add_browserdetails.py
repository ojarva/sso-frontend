...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'KeystrokeSequence'
        db.create_table(u'login_frontend_keystrokesequence', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('browser', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['login_frontend.Browser'], null=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['login_frontend.User'])),
            ('resolution', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('fieldname', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('was_correct', self.gf('django.db.models.fields.BooleanField')()),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')()),
            ('timing', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'login_frontend', ['KeystrokeSequence'])

        # Adding model 'BrowserDetails'
        db.create_table(u'login_frontend_browserdetails', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('browser', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['login_frontend.Browser'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')()),
            ('remote_clock_offset', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('remote_clock_time', self.gf('django.db.models.fields.CharField')(max_length=28, null=True, blank=True)),
            ('performance_performance', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('performance_memory', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('performance_timing', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('performance_navigation', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('resolution', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('plugins', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'login_frontend', ['BrowserDetails'])


    def backwards(self, orm):
        # Deleting model 'KeystrokeSequence'
        db.delete_table(u'login_frontend_keystrokesequence')

        # Deleting model 'BrowserDetails'
        db.delete_table(u'login_frontend_browserdetails')
    ...
    models = {
        ...
        u'login_frontend.usedotp': {
            ...
            'used_from': ('django.db.models.fields.GenericIPAddressField', [], {'max_length': '39', 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['login_frontend.User']"})
        },
        u'login_frontend.user': {
            ...
            'strong_skips_available': ('django.db.models.fields.IntegerField', [], {'default': '6'}),
