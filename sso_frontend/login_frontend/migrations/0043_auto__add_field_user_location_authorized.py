...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.location_authorized'
        db.add_column(u'login_frontend_user', 'location_authorized',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.location_authorized'
        db.delete_column(u'login_frontend_user', 'location_authorized')
