...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.yubikey_uid'
        db.add_column(u'login_frontend_user', 'yubikey_uid',
                      self.gf('django.db.models.fields.CharField')(max_length=16, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.yubikey_secret'
        db.add_column(u'login_frontend_user', 'yubikey_secret',
                      self.gf('django.db.models.fields.CharField')(max_length=52, unique=True, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'User.yubikey_uid'
        db.delete_column(u'login_frontend_user', 'yubikey_uid')
    ...
    models = {
        ...
        u'login_frontend.user': {
            ...
            'yubikey_last_id': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'yubikey_last_temp_id': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'yubikey_last_timestamp': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'yubikey_secret': ('django.db.models.fields.CharField', [], {'max_length': '52', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'yubikey_uid': ('django.db.models.fields.CharField', [], {'max_length': '16', 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
