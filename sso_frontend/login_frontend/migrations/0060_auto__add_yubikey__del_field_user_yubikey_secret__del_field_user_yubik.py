...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'login_frontend_yubikey', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('public_uid', self.gf('django.db.models.fields.CharField')(max_length=16, unique=True, null=True, blank=True)),
            ('internal_uid', self.gf('django.db.models.fields.CharField')(max_length=16, unique=True, null=True, blank=True)),
            ('secret', self.gf('django.db.models.fields.CharField')(max_length=52, unique=True, null=True, blank=True)),
            ('last_id', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('last_temp_id', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('last_timestamp', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('compromised', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'login_frontend', ['Yubikey'])

        # Deleting field 'User.yubikey_secret'
        db.delete_column(u'login_frontend_user', 'yubikey_secret')

        # Deleting field 'User.yubikey_last_id'
        db.delete_column(u'login_frontend_user', 'yubikey_last_id')

        # Deleting field 'User.yubikey_public_uid'
        db.delete_column(u'login_frontend_user', 'yubikey_public_uid')

        # Deleting field 'User.yubikey_internal_uid'
        db.delete_column(u'login_frontend_user', 'yubikey_internal_uid')

        # Deleting field 'User.yubikey_last_timestamp'
        db.delete_column(u'login_frontend_user', 'yubikey_last_timestamp')

        # Deleting field 'User.yubikey_last_temp_id'
        db.delete_column(u'login_frontend_user', 'yubikey_last_temp_id')

        # Adding field 'User.yubikey'
        db.add_column(u'login_frontend_user', 'yubikey',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['login_frontend.Yubikey'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Yubikey'
        db.delete_table(u'login_frontend_yubikey')

        # Adding field 'User.yubikey_secret'
        db.add_column(u'login_frontend_user', 'yubikey_secret',
                      self.gf('django.db.models.fields.CharField')(unique=True, max_length=52, null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.yubikey_last_id'
        db.add_column(u'login_frontend_user', 'yubikey_last_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'User.yubikey_public_uid'
        db.add_column(u'login_frontend_user', 'yubikey_public_uid',
                      self.gf('django.db.models.fields.CharField')(unique=True, max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.yubikey_internal_uid'
        db.add_column(u'login_frontend_user', 'yubikey_internal_uid',
                      self.gf('django.db.models.fields.CharField')(unique=True, max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.yubikey_last_timestamp'
        db.add_column(u'login_frontend_user', 'yubikey_last_timestamp',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'User.yubikey_last_temp_id'
        db.add_column(u'login_frontend_user', 'yubikey_last_temp_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'User.yubikey'
        db.delete_column(u'login_frontend_user', 'yubikey_id')
    ...
    models = {
        ...
        u'login_frontend.user': {
            ...
            'is_admin': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'location_authorized': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            ...
            'strong_authenticator_used': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            ...
            'yubikey': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['login_frontend.Yubikey']", 'null': 'True'})
        },
        ...
        u'login_frontend.userservice': {
            'Meta': {'object_name': 'UserService', 'index_together': "[['user', 'last_accessed']]"},
            'access_count': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'login_frontend.yubikey': {
            'Meta': {'object_name': 'Yubikey'},
            'compromised': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'internal_uid': ('django.db.models.fields.CharField', [], {'max_length': '16', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'last_id': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'last_temp_id': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'last_timestamp': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'public_uid': ('django.db.models.fields.CharField', [], {'max_length': '16', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '52', 'unique': 'True', 'null': 'True', 'blank': 'True'})
        }
    }
