...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BrowserTime'
        db.create_table(u'login_frontend_browsertime', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('browser', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['login_frontend.Browser'])),
            ('checked_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('timezone', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('time_diff', self.gf('django.db.models.fields.IntegerField')()),
            ('measurement_error', self.gf('django.db.models.fields.DecimalField')(max_digits=11, decimal_places=3)),
        ))
        db.send_create_signal(u'login_frontend', ['BrowserTime'])


    def backwards(self, orm):
        # Deleting model 'BrowserTime'
        db.delete_table(u'login_frontend_browsertime')
