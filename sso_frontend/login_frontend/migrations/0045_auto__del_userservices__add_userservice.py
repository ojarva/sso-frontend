...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'UserServices'
        db.delete_table(u'login_frontend_userservices')

        # Adding model 'UserService'
        db.create_table(u'login_frontend_userservice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['login_frontend.User'])),
            ('last_accessed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('service_url', self.gf('django.db.models.fields.CharField')(max_length=2000)),
            ('access_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'login_frontend', ['UserService'])


    def backwards(self, orm):
        # Adding model 'UserServices'
        db.create_table(u'login_frontend_userservices', (
            ('access_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('last_accessed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('service_url', self.gf('django.db.models.fields.CharField')(max_length=2000)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['login_frontend.User'])),
        ...
        db.send_create_signal(u'login_frontend', ['UserServices'])

        # Deleting model 'UserService'
        db.delete_table(u'login_frontend_userservice')
