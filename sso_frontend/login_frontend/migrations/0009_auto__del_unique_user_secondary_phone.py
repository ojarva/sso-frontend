...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'User', fields ['secondary_phone']
        db.delete_unique(u'login_frontend_user', ['secondary_phone'])


    def backwards(self, orm):
        # Adding unique constraint on 'User', fields ['secondary_phone']
        db.create_unique(u'login_frontend_user', ['secondary_phone'])
