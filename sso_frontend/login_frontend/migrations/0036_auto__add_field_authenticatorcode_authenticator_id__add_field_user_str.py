...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AuthenticatorCode.authenticator_id'
        db.add_column(u'login_frontend_authenticatorcode', 'authenticator_id',
                      self.gf('django.db.models.fields.CharField')(default='undefined', max_length=30),
                      keep_default=False)

        # Adding field 'User.strong_authenticator_id'
        db.add_column(u'login_frontend_user', 'strong_authenticator_id',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.strong_authenticator_num'
        db.add_column(u'login_frontend_user', 'strong_authenticator_num',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AuthenticatorCode.authenticator_id'
        db.delete_column(u'login_frontend_authenticatorcode', 'authenticator_id')

        # Deleting field 'User.strong_authenticator_id'
        db.delete_column(u'login_frontend_user', 'strong_authenticator_id')

        # Deleting field 'User.strong_authenticator_num'
        db.delete_column(u'login_frontend_user', 'strong_authenticator_num')
