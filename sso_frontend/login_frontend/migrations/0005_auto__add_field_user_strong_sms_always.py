...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.strong_sms_always'
        db.add_column(u'login_frontend_user', 'strong_sms_always',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.strong_sms_always'
        db.delete_column(u'login_frontend_user', 'strong_sms_always')
