...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BrowserP0f.last_nat'
        db.alter_column(u'login_frontend_browserp0f', 'last_nat', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'BrowserP0f.last_nat'
        raise RuntimeError("Cannot reverse this migration. 'BrowserP0f.last_nat' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'BrowserP0f.last_nat'
        db.alter_column(u'login_frontend_browserp0f', 'last_nat', self.gf('django.db.models.fields.DateTimeField')())
