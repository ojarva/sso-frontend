...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BrowserLogin'
        db.create_table(u'login_frontend_browserlogin', (
            ...
            ('sso_provider', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('remote_service', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True)),
            ...
            ('can_logout', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('expires_at', self.gf('django.db.models.fields.DateTimeField')(null=True)),
        ))
        db.send_create_signal(u'login_frontend', ['BrowserLogin'])


    def backwards(self, orm):
        # Deleting model 'BrowserLogin'
        db.delete_table(u'login_frontend_browserlogin')
