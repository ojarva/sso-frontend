...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'UserService', fields ['access_count']
        db.create_index(u'login_frontend_userservice', ['access_count'])

        # Adding index on 'UserService', fields ['user', 'last_accessed']
        db.create_index(u'login_frontend_userservice', ['user_id', 'last_accessed'])

        # Adding index on 'User', fields ['location_authorized']
        db.create_index(u'login_frontend_user', ['location_authorized'])

        # Adding index on 'User', fields ['strong_authenticator_used']
        db.create_index(u'login_frontend_user', ['strong_authenticator_used'])

        # Adding index on 'User', fields ['is_admin']
        db.create_index(u'login_frontend_user', ['is_admin'])


    def backwards(self, orm):
        # Removing index on 'User', fields ['is_admin']
        db.delete_index(u'login_frontend_user', ['is_admin'])

        # Removing index on 'User', fields ['strong_authenticator_used']
        db.delete_index(u'login_frontend_user', ['strong_authenticator_used'])

        # Removing index on 'User', fields ['location_authorized']
        db.delete_index(u'login_frontend_user', ['location_authorized'])

        # Removing index on 'UserService', fields ['user', 'last_accessed']
        db.delete_index(u'login_frontend_userservice', ['user_id', 'last_accessed'])

        # Removing index on 'UserService', fields ['access_count']
        db.delete_index(u'login_frontend_userservice', ['access_count'])
