...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Log.status'
        db.add_column(u'login_frontend_log', 'status',
                      self.gf('django.db.models.fields.CharField')(default='question', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Log.status'
        db.delete_column(u'login_frontend_log', 'status')
