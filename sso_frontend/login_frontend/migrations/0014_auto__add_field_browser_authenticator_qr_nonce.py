...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Browser.authenticator_qr_nonce'
        db.add_column(u'login_frontend_browser', 'authenticator_qr_nonce',
                      self.gf('django.db.models.fields.CharField')(max_length=37, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Browser.authenticator_qr_nonce'
        db.delete_column(u'login_frontend_browser', 'authenticator_qr_nonce')
