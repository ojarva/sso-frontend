...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BrowserP0f.wraparounds'
        db.add_column(u'login_frontend_browserp0f', 'wraparounds',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BrowserP0f.wraparounds'
        db.delete_column(u'login_frontend_browserp0f', 'wraparounds')
