...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Browser.username'
        db.delete_column(u'login_frontend_browser', 'username_id')

        # Adding field 'Browser.user'
        db.add_column(u'login_frontend_browser', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['login_frontend.User'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Browser.username'
        db.add_column(u'login_frontend_browser', 'username',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['login_frontend.User'], null=True),
                      keep_default=False)

        # Deleting field 'Browser.user'
        db.delete_column(u'login_frontend_browser', 'user_id')
