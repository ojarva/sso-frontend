...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.emulate_legacy'
        db.add_column(u'login_frontend_user', 'emulate_legacy',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.emulate_legacy'
        db.delete_column(u'login_frontend_user', 'emulate_legacy')
