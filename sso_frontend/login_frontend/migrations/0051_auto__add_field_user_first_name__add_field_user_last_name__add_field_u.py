...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'login_frontend_user', 'first_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.last_name'
        db.add_column(u'login_frontend_user', 'last_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.password_changed'
        db.add_column(u'login_frontend_user', 'password_changed',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'User.password_expires'
        db.add_column(u'login_frontend_user', 'password_expires',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'login_frontend_user', 'first_name')

        # Deleting field 'User.last_name'
        db.delete_column(u'login_frontend_user', 'last_name')

        # Deleting field 'User.password_changed'
        db.delete_column(u'login_frontend_user', 'password_changed')

        # Deleting field 'User.password_expires'
        db.delete_column(u'login_frontend_user', 'password_expires')
