...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Browser', fields ['auth_level']
        db.create_index(u'login_frontend_browser', ['auth_level'])

        # Adding index on 'Browser', fields ['bid_session']
        db.create_index(u'login_frontend_browser', ['bid_session'])

        # Adding index on 'Browser', fields ['bid_public']
        db.create_index(u'login_frontend_browser', ['bid_public'])

        # Adding index on 'Browser', fields ['forced_sign_out']
        db.create_index(u'login_frontend_browser', ['forced_sign_out'])

        # Adding index on 'Browser', fields ['auth_state']
        db.create_index(u'login_frontend_browser', ['auth_state'])

        # Adding index on 'Log', fields ['bid_public']
        db.create_index(u'login_frontend_log', ['bid_public'])

        # Adding index on 'Log', fields ['remote_ip']
        db.create_index(u'login_frontend_log', ['remote_ip'])


    def backwards(self, orm):
        # Removing index on 'Log', fields ['remote_ip']
        db.delete_index(u'login_frontend_log', ['remote_ip'])

        # Removing index on 'Log', fields ['bid_public']
        db.delete_index(u'login_frontend_log', ['bid_public'])

        # Removing index on 'Browser', fields ['auth_state']
        db.delete_index(u'login_frontend_browser', ['auth_state'])

        # Removing index on 'Browser', fields ['forced_sign_out']
        db.delete_index(u'login_frontend_browser', ['forced_sign_out'])

        # Removing index on 'Browser', fields ['bid_public']
        db.delete_index(u'login_frontend_browser', ['bid_public'])

        # Removing index on 'Browser', fields ['bid_session']
        db.delete_index(u'login_frontend_browser', ['bid_session'])

        # Removing index on 'Browser', fields ['auth_level']
        db.delete_index(u'login_frontend_browser', ['auth_level'])
    ...
    models = {
        ...
        u'login_frontend.browserlogin': {
            'Meta': {'ordering': "['-auth_timestamp', 'sso_provider', 'remote_service']", 'object_name': 'BrowserLogin', 'index_together': "[['signed_out', 'expires_at']]"},
        ...
        u'login_frontend.browsertime': {
            ...
            'browser': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['login_frontend.Browser']"}),
            'checked_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
