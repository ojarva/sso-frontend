...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BrowserLogin.expires_session'
        db.add_column(u'login_frontend_browserlogin', 'expires_session',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BrowserLogin.expires_session'
        db.delete_column(u'login_frontend_browserlogin', 'expires_session')
