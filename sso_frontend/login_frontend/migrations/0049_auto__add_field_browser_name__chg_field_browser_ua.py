...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'Browser.ua'
        db.alter_column(u'login_frontend_browser', 'ua', self.gf('django.db.models.fields.CharField')(max_length=500))

    def backwards(self, orm):
        # Changing field 'Browser.ua'
        db.alter_column(u'login_frontend_browser', 'ua', self.gf('django.db.models.fields.CharField')(max_length=250))
