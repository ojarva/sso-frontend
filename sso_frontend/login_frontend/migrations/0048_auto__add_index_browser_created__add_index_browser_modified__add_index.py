...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Browser', fields ['created']
        db.create_index(u'login_frontend_browser', ['created'])

        # Adding index on 'Browser', fields ['modified']
        db.create_index(u'login_frontend_browser', ['modified'])

        # Adding index on 'BrowserUsers', fields ['auth_timestamp']
        db.create_index(u'login_frontend_browserusers', ['auth_timestamp'])

        # Adding index on 'BrowserP0f', fields ['updated_at']
        db.create_index(u'login_frontend_browserp0f', ['updated_at'])

        # Adding index on 'BrowserP0f', fields ['first_seen']
        db.create_index(u'login_frontend_browserp0f', ['first_seen'])

        # Adding index on 'BrowserP0f', fields ['last_seen']
        db.create_index(u'login_frontend_browserp0f', ['last_seen'])

        # Adding index on 'BrowserLogin', fields ['auth_timestamp']
        db.create_index(u'login_frontend_browserlogin', ['auth_timestamp'])

        # Adding index on 'BrowserLogin', fields ['sso_provider']
        db.create_index(u'login_frontend_browserlogin', ['sso_provider'])

        # Adding index on 'BrowserLogin', fields ['auth_timestamp', 'sso_provider']
        db.create_index(u'login_frontend_browserlogin', ['auth_timestamp', 'sso_provider'])

        # Adding index on 'BrowserTime', fields ['checked_at']
        db.create_index(u'login_frontend_browsertime', ['checked_at'])

        # Adding index on 'Log', fields ['timestamp']
        db.create_index(u'login_frontend_log', ['timestamp'])


    def backwards(self, orm):
        # Removing index on 'Log', fields ['timestamp']
        db.delete_index(u'login_frontend_log', ['timestamp'])

        # Removing index on 'BrowserTime', fields ['checked_at']
        db.delete_index(u'login_frontend_browsertime', ['checked_at'])

        # Removing index on 'BrowserLogin', fields ['auth_timestamp', 'sso_provider']
        db.delete_index(u'login_frontend_browserlogin', ['auth_timestamp', 'sso_provider'])

        # Removing index on 'BrowserLogin', fields ['sso_provider']
        db.delete_index(u'login_frontend_browserlogin', ['sso_provider'])

        # Removing index on 'BrowserLogin', fields ['auth_timestamp']
        db.delete_index(u'login_frontend_browserlogin', ['auth_timestamp'])

        # Removing index on 'BrowserP0f', fields ['last_seen']
        db.delete_index(u'login_frontend_browserp0f', ['last_seen'])

        # Removing index on 'BrowserP0f', fields ['first_seen']
        db.delete_index(u'login_frontend_browserp0f', ['first_seen'])

        # Removing index on 'BrowserP0f', fields ['updated_at']
        db.delete_index(u'login_frontend_browserp0f', ['updated_at'])

        # Removing index on 'BrowserUsers', fields ['auth_timestamp']
        db.delete_index(u'login_frontend_browserusers', ['auth_timestamp'])

        # Removing index on 'Browser', fields ['modified']
        db.delete_index(u'login_frontend_browser', ['modified'])

        # Removing index on 'Browser', fields ['created']
        db.delete_index(u'login_frontend_browser', ['created'])
