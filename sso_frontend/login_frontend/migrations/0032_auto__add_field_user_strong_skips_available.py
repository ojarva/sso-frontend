...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.strong_skips_available'
        db.add_column(u'login_frontend_user', 'strong_skips_available',
                      self.gf('django.db.models.fields.IntegerField')(default=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.strong_skips_available'
        db.delete_column(u'login_frontend_user', 'strong_skips_available')
