...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Log.bid_public'
        db.alter_column(u'login_frontend_log', 'bid_public', self.gf('django.db.models.fields.CharField')(max_length=37, null=True))

    def backwards(self, orm):

        # Changing field 'Log.bid_public'
        db.alter_column(u'login_frontend_log', 'bid_public', self.gf('django.db.models.fields.CharField')(default=' ', max_length=37))
