...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.user_tokens'
        db.add_column(u'login_frontend_user', 'user_tokens',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.user_tokens'
        db.delete_column(u'login_frontend_user', 'user_tokens')
