...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UsedOTP'
        db.create_table(u'login_frontend_usedotp', (
            ...
            ('used_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('used_from', self.gf('django.db.models.fields.CharField')(max_length=46, null=True, blank=True)),
        ))
        db.send_create_signal(u'login_frontend', ['UsedOTP'])

        # Adding field 'User.strong_authenticator_used'
        db.add_column(u'login_frontend_user', 'strong_authenticator_used',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'UsedOTP'
        db.delete_table(u'login_frontend_usedotp')

        # Deleting field 'User.strong_authenticator_used'
        db.delete_column(u'login_frontend_user', 'strong_authenticator_used')
