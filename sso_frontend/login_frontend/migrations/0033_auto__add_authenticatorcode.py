...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AuthenticatorCode'
        db.create_table(u'login_frontend_authenticatorcode', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['login_frontend.User'])),
            ('generated_at', self.gf('django.db.models.fields.DateTimeField')()),
            ('authenticator_secret', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'login_frontend', ['AuthenticatorCode'])


    def backwards(self, orm):
        # Deleting model 'AuthenticatorCode'
        db.delete_table(u'login_frontend_authenticatorcode')
