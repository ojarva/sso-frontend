...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmergencyCodes.downloaded_at'
        db.add_column(u'login_frontend_emergencycodes', 'downloaded_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'EmergencyCodes.downloaded_with'
        db.add_column(u'login_frontend_emergencycodes', 'downloaded_with',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['login_frontend.Browser'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmergencyCodes.downloaded_at'
        db.delete_column(u'login_frontend_emergencycodes', 'downloaded_at')

        # Deleting field 'EmergencyCodes.downloaded_with'
        db.delete_column(u'login_frontend_emergencycodes', 'downloaded_with_id')
