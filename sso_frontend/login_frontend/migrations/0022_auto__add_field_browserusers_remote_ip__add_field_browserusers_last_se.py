...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BrowserUsers.remote_ip'
        db.add_column(u'login_frontend_browserusers', 'remote_ip',
                      self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BrowserUsers.last_seen'
        db.add_column(u'login_frontend_browserusers', 'last_seen',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BrowserUsers.remote_ip'
        db.delete_column(u'login_frontend_browserusers', 'remote_ip')

        # Deleting field 'BrowserUsers.last_seen'
        db.delete_column(u'login_frontend_browserusers', 'last_seen')
