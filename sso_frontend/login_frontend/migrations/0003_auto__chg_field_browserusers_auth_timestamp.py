...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BrowserUsers.auth_timestamp'
        db.alter_column(u'login_frontend_browserusers', 'auth_timestamp', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'BrowserUsers.auth_timestamp'
        raise RuntimeError("Cannot reverse this migration. 'BrowserUsers.auth_timestamp' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'BrowserUsers.auth_timestamp'
        db.alter_column(u'login_frontend_browserusers', 'auth_timestamp', self.gf('django.db.models.fields.DateTimeField')())
