...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'BrowserLogin', fields ['signed_out', 'expires_at']
        db.create_index(u'login_frontend_browserlogin', ['signed_out', 'expires_at'])


    def backwards(self, orm):
        # Removing index on 'BrowserLogin', fields ['signed_out', 'expires_at']
        db.delete_index(u'login_frontend_browserlogin', ['signed_out', 'expires_at'])
