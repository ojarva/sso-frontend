...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BrowserLogin.signed_out'
        db.add_column(u'login_frontend_browserlogin', 'signed_out',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BrowserLogin.signed_out'
        db.delete_column(u'login_frontend_browserlogin', 'signed_out')
